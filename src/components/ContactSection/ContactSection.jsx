...
const ContactSection = () => {
  return (
    <section className='h-200 flex items-center justify-center bg-orange-400' >
         <form className='flex flex-col   items-center bg-white p-25 h-160 justify-around'>
            ...
            <div className='flex flex-col w-full sm:flex-row gap-3'>
                <textarea className='w-full sm:w-124 mt-3 h-30 border border-gray-600' placeholder='Enter your message'></textarea>
            </div>
